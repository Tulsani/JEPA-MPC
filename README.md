...
Instead of comparing every prediction to its ground truth equally, you apply VICReg only at specific steps, with weights. At steps [1,3,5,] -> horizon weights [0.5,0.3,0.2]
